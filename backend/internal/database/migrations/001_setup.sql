...
-- Expense categories
(UUID(), NULL, 'Alimentacao', 'Gastos com alimentacao e restaurantes', 'expense', '#EF4444', 'utensils', TRUE),
(UUID(), NULL, 'Transporte', 'Gastos com transporte e combustivel', 'expense', '#F59E0B', 'car', TRUE),
(UUID(), NULL, 'Moradia', 'Aluguel, condominio e contas da casa', 'expense', '#10B981', 'home', TRUE),
(UUID(), NULL, 'Saude', 'Consultas, remedios e plano de saude', 'expense', '#EC4899', 'heart', TRUE),
(UUID(), NULL, 'Educacao', 'Cursos, livros e materiais', 'expense', '#8B5CF6', 'book', TRUE),
(UUID(), NULL, 'Lazer', 'Entretenimento e diversao', 'expense', '#06B6D4', 'gamepad', TRUE),
(UUID(), NULL, 'Compras', 'Compras diversas', 'expense', '#F97316', 'shopping-bag', TRUE),
(UUID(), NULL, 'Servicos', 'Assinaturas e servicos', 'expense', '#6366F1', 'settings', TRUE),
(UUID(), NULL, 'Outros Despesas', 'Despesas diversas', 'expense', '#6B7280', 'more-horizontal', TRUE),
-- Income categories
(UUID(), NULL, 'Salario', 'Salario e proventos', 'income', '#22C55E', 'briefcase', TRUE),
(UUID(), NULL, 'Freelance', 'Trabalhos freelance', 'income', '#14B8A6', 'laptop', TRUE),
(UUID(), NULL, 'Investimentos', 'Rendimentos de investimentos', 'income', '#3B82F6', 'trending-up', TRUE),
(UUID(), NULL, 'Presente', 'Dinheiro recebido de presente', 'income', '#A855F7', 'gift', TRUE),
