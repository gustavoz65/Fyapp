...
import type { DashboardSummary, MonthlyIncomeExpense, Transaction } from "@/types";
...
export default function DashboardPage() {
  ...
  const defaultSummary: DashboardSummary = {
    total_balance: "0", total_accounts: 0, month_income: "0", month_expense: "0",
    month_balance: "0", income_change: "0", expense_change: "0", active_budgets: 0,
    over_budget_count: 0, budget_usage: "0", active_goals: 0, goals_progress: "0",
    upcoming_bills: 0, upcoming_total: "0", recent_transactions: [], top_categories: [],
  };
