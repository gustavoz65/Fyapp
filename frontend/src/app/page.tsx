      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#how-it-works" className="text-foreground/70 hover:text-foreground transition-colors">Como Funciona</a>
            <a href="#security" className="text-foreground/70 hover:text-foreground transition-colors">Segurança</a>
          </div>
          <Link href="/login">
        ...
        <div className="container relative z-10 py-24 md:py-32">
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight">
              Seu Dinheiro, <span className="text-primary">Melhor</span> Controlado
            </h1>
            <p className="text-lg md:text-xl text-foreground/70 mb-8 leading-relaxed">
              FiNext é a plataforma de gestão financeira moderna que torna simples o controle de suas transações, orçamentos e metas. Segurança e simplicidade em um só lugar.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/register">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-base w-full sm:w-auto">
        ...
        <div className="container">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
              A maioria das pessoas luta para entender seus gastos e planejar o futuro financeiro. FiNext muda isso oferecendo uma visão clara e em tempo real de suas finanças, com ferramentas intuitivas que qualquer um pode usar.
            </p>
            ...
            {[
              {
                ...
                description: "Visualize suas finanças em tempo real com gráficos interativos"
              },
              {
                icon: TrendingUp,
                title: "Análise de Gastos",
                description: "Entenda seus padrões de gastos e identifique oportunidades"
              },
              {
                icon: Smartphone,
                title: "Acesso em Qualquer Lugar",
                description: "Gerencie suas finanças no desktop, tablet ou smartphone"
              },
              {
                icon: Lock,
                title: "Segurança de Banco",
                description: "Seus dados são protegidos com criptografia de nível militar"
              }
            ].map((feature, idx) => {
            ...
            {[
              {
                ...
                description: "Cadastro rápido e seguro. Leva menos de 2 minutos."
              },
              {
                step: "2",
                title: "Conecte suas Contas",
                description: "Integre suas contas bancárias de forma segura e automática."
              },
              {
                step: "3",
                title: "Comece a Controlar",
                description: "Visualize, analise e controle suas finanças em tempo real."
              }
            ].map((item, idx) => (
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
                Seus dados financeiros são os mais sensíveis. Por isso, implementamos os mais altos padrões de segurança da indústria.
              </p>
            ...
            <div className="bg-card p-8 rounded-lg border border-border">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-foreground">Proteção SSL/TLS</h4>
                    <p className="text-sm text-foreground/70">Todas as conexões são criptografadas</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <Zap className="w-8 h-8 text-primary" />
                  <div>
                    <h4 className="font-bold text-foreground">Backup Automático</h4>
                    <p className="text-sm text-foreground/70">Seus dados são salvos continuamente</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <Shield className="w-8 h-8 text-primary" />
                  <div>
                    <h4 className="font-bold text-foreground">Monitoramento 24/7</h4>
                    <p className="text-sm text-foreground/70">Detecção de atividades suspeitas</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Junte-se a milhares de usuários que já estão controlando suas finanças com FiNext
          </p>
          <Link href="/register">
            <Button
              size="lg"
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-foreground/70">Gestão financeira moderna e segura</p>
            </div>
            <div>
